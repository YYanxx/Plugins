 ...
 * @source https://github.com/YYanxx/YanxxPlugins/blob/main/YanxxStereo.js
 */
/*@cc_on
@if (@_jscript)
...
module.exports = (() => {
    const config = {"main":"index.js","info":{"name":"XendoStereo","authors":[{"name":"By Yanxx","discord_id":"729397565065527306","":""}],"authorLink":"","version":"0.0.1","description":"Custom Stereo Plugin By Yanxx There Will Be More In The Future.","github":"https://github.com/YYanxx/YanxxPlugins","github_raw":"https://github.com/YYanxx/YanxxPlugins/blob/main/YanxxStereo.js"},"changelog":[{"title":"Changes","items":["Adjusted warning toast behavior"]}],"defaultConfig":[{"type":"switch","id":"enableToasts","name":"Enable Toasts","note":"Allows the plugin to let you know it is working, and also warn you about voice settings","value":true}]};
    ...
    replacement(thisObj, _args, ret) {
      ...
      thisObj.conn.setTransportOptions = function (obj) {
        if (obj.audioEncoder) {
			...
			if (obj.encodingVoiceBitRate < 1024000 ) { //2048
