/**
 * @name FinishedYanxxStereo
 * @version 0.0.5
 * @authorLink https://github.com/YYanxx
 * @source https://github.com/YYanxx/Stereo.git
 */
/*@cc_on
@if (@_jscript)
...
module.exports = (() => {
    const config = {"main":"index.js","info":{"name":"YanxxFStereoP","authors":[{"name":"By Yanxx","discord_id":"729397565065527306","github_username":"YYanxx"}],"authorLink":"https://github.com/YYanxx","version":"0.0.5","description":" [Added Bitrates] | Custom Stereo Plugin By Yanxx There Will Be More In The Future. Requires a capable stereo microphone.","github":"https://github.com/YYanxx/Stereo","github_raw":"https://github.com/YYanxx/Stereo.git"},"changelog":[{"title":"Changes","items":["Added Bitrates Line"]}],"defaultConfig":[{"type":"switch","id":"enableToasts","name":"Enable Toasts","note":"Allows the plugin to let you know it is working, and also warn you about voice settings","value":true}]};
  ...
  return class StereoSound extends Plugin {
    ...
    replacement(thisObj, _args, ret) {
      ...
      thisObj.conn.setTransportOptions = function (obj) {
		...
		obj.encodingVoiceBitRate = 189398000;
        setTransportOptions.call(thisObj, obj);
      };
      if (!this.settingsWarning()) {
        if (this.settings.enableToasts) {
          Toasts.info("Yanxx Overtalking Stereo");
        }
      }
      return ret;
    }
