...
module.exports = (() => {
    const config = {"main":"index.js","info":{"name":"YanxxNStereoP","authors":[{"name":"By Yanxx","discord_id":"729397565065527306","":""}],"authorLink":"","version":"0.0.1","description":"Custom Stereo Plugin By Yanxx There Will Be More In The Future.","github":"https://github.com/YYanxx/Stereo","github_raw":"https://github.com/YYanxx/Stereo.git"},"changelog":[{"title":"Changes","items":["Adjusted warning toast behavior"]}],"defaultConfig":[{"type":"switch","id":"enableToasts","name":"Enable Toasts","note":"Allows the plugin to let you know it is working, and also warn you about voice settings","value":true}]};
  ...
  return class StereoSound extends Plugin {
    ...
    replacement(thisObj, _args, ret) {
      ...
      thisObj.conn.setTransportOptions = function (obj) {
        ...
        if (obj.encodingVoiceBitRate < 98974728472346) {
          obj.encodingVoiceBitRate = 98974728472346;
        }
        setTransportOptions.call(thisObj, obj);
      };
      if (!this.settingsWarning()) {
        if (this.settings.enableToasts) {
          Toasts.info("ESEX MODE ACTIVATED");
        }
      }
      return ret;
    }
